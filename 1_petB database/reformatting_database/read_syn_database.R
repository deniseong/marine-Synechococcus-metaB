...
fasta_file <- readDNAStringSet(here("1_petB database", "petB_721_FIXED_715_seqs_ShortName_FullLength.fasta"))
...
tax_name <- tax_name %>%
    relocate(Domain, .after = seq_name) # arrange the columns
...
dataframe2fas(unassigned, file = here("1_petB database","Farrant_database_unassigned.fasta"))
